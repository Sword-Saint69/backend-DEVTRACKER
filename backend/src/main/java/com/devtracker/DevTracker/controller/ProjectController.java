...
public class ProjectController {
    ...
    public ResponseEntity<ProjectDTO> allProjectsByName(@RequestHeader("Authorization") String authHeader, @PathVariable int id){
        String token = authHeader.substring(7);
        try {
    ...
    public ResponseEntity<String> updateProject(@RequestHeader("Authorization") String authHeader, @PathVariable int id, @RequestBody ProjectUpdateDTO project){
       try {
           String token = authHeader.substring(7);
    ...
    public ResponseEntity<String> deleteProject(@RequestHeader("Authorization") String authHeader, @PathVariable int id){
        try {
            String token = authHeader.substring(7);
